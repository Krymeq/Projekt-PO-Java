...
import classes.runnables.Byt;
import javax.swing.JFrame;

/**
 * Okno do pokazania informacji o 
 * @author Kiosku
 */
public class InfoWindow extends JFrame {

    /**
     * Konstruktor - tworzy nowe okno informacyjne.
     * @param x - Byt, którego informacje wyświetlamy.
     */
    public InfoWindow(Byt x) 
    {
        super("Informacje");
        initComponents();
        this.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        this.editArea.setText(x.returnInfo());
    }
